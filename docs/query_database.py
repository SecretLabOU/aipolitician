...
Usage:
    python query_database.py --query "climate change"
    python query_database.py --list-all
    python query_database.py --id <politician-id>
"""
...
def format_politician(politician, detailed=False):
    ...
    output.append(f"Biography: {politician.get('biography', 'N/A')}")
...
def main():
    ...
    parser.add_argument("--db-path", default="/home/natalie/political_db", 
        ...
        if args.query:
            ...
            for i, politician in enumerate(all_politicians, 1):
                ...
                if args.detailed:
                    ...
                    print(f"   {politician.get('biography', '')}")
                    print("")
